...
public class ClientSettingsScreen extends Screen {
    ...
    private List<NestedGui> makePageOne() {
        ...
        optionRows.add(
                new LabeledGui(fontRenderer,
                        new TextComponentTranslation("chopdownupdated.gui.settings.label.chopping"),
        ...
        if (ConfigHandler.CLIENT.showFellingOptions.get()) {
            optionRows.add(
                    new LabeledGui(fontRenderer,
                            new TextComponentTranslation("chopdownupdated.gui.settings.label.felling"),
            ...
            optionRows.add(
                    new LabeledGui(fontRenderer,
                            new TextComponentTranslation("chopdownupdated.gui.settings.label.sneaking_inverts"),
                            new ExclusiveButtonsGui.Builder()
                                    .add(
                                            new TextComponentTranslation("chopdownupdated.gui.settings.button.chopping"),
                                    ...
                                    .add(
                                            new TextComponentTranslation("chopdownupdated.gui.settings.button.felling"),
                                    ...
                                    .add(
                                            new TextComponentTranslation("chopdownupdated.gui.settings.button.nothing"),
            ...
            optionRows.add(
                    new LabeledGui(fontRenderer,
                            new TextComponentTranslation("chopdownupdated.gui.settings.label.sneaking_inverts_chopping"),
                            new ToggleGui(
        ...
        optionRows.add(
                new LabeledGui(fontRenderer,
                        new TextComponentTranslation("chopdownupdated.gui.settings.label.only_chop_trees_with_leaves"),
        ...
        if (Minecraft.getMinecraft().player != null && Minecraft.getMinecraft().player.isCreative()) {
            optionRows.add(
                    new LabeledGui(fontRenderer,
                            new TextComponentTranslation("chopdownupdated.gui.settings.label.chop_in_creative_mode"),
    ...
    private LinkedList<NestedGui> makePageTwo() {
        ...
        optionRows.add(
                new LabeledGui(fontRenderer,
                        new TextComponentTranslation("chopdownupdated.gui.settings.label.chopping_indicator"),
                        new ToggleGui(
        ...
        optionRows.add(
                new LabeledGui(fontRenderer,
                        new TextComponentTranslation("chopdownupdated.gui.settings.label.feedback_messages"),
                        new ToggleGui(
        ...
        optionRows.add(
                new LabeledGui(fontRenderer,
                        new TextComponentTranslation("chopdownupdated.gui.settings.label.felling_options"),
                        new ToggleGui(
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        String title = I18n.format("chopdownupdated.gui.settings.title", TreeChopMod.MOD_NAME);
