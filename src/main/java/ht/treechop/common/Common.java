...
public class Common {
    ...
    public void onBreakEvent(BlockEvent.BreakEvent event) {
        // Embedded in ChopDownUpdated: the chop-layer mechanic only runs in
        // TREECHOP mode; CHOPDOWN/BOTH are handled by ChopDown's BreakEvent.
        if (com.shovinus.chopdownupdated.config.Config.treeMode
                != com.shovinus.chopdownupdated.config.Config.TreeMode.TREECHOP) {
            return;
        }
