...
public enum SneakBehavior implements IStringSerializable {
    NONE("chopdownupdated.sneak_behavior.none", agent -> false, agent -> false),
    INVERT_CHOPPING("chopdownupdated.sneak_behavior.invert_chopping", Entity::isSneaking, agent -> false),
    INVERT_FELLING("chopdownupdated.sneak_behavior.invert_felling", agent -> false, Entity::isSneaking)
    ;
