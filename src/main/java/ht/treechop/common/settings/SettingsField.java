...
public enum SettingsField {
    CHOPPING("choppingEnabled", "chopdownupdated.setting.chopping", Boolean.TRUE),
    FELLING("fellingEnabled", "chopdownupdated.setting.felling", Boolean.TRUE),
    SNEAK_BEHAVIOR("sneakBehavior", "chopdownupdated.setting.sneak_behavior", SneakBehavior.INVERT_CHOPPING),
    TREES_MUST_HAVE_LEAVES("treeMustHaveLeaves", "chopdownupdated.setting.trees_must_have_leaves", Boolean.TRUE),
    CHOP_IN_CREATIVE_MODE("chopInCreativeMode", "chopdownupdated.setting.chop_in_creative_mode", Boolean.FALSE)
    ;
